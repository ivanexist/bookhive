  ...
  <footer className="bg-blumine-100 text-center text-gray-950  lg:text-left">
    ...
    <div className="mx-6 py-10 text-center md:text-left">
      <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        {/* TW Elements Section */}
        <div>
          <h6 className="mb-4 flex items-center font-semibold uppercase justify-start text-blumine-600">
        ...
        <div>
          ...
          <div className="flex flex-col justify-start ">
            <div className="flex my-2">
              <span>
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="mr-4 h-5 w-5 text-blumine-600"
                >
            ...
            <div className="flex my-2">
              ...
              <span className="text-gray-500">info@bookhive.com</span>
            </div>
            <div className="flex my-2">
              <span>
                <svg
              ...
              <span className="text-gray-500">+ 62 853 305 11771</span>
            </div>
          </div>
        </div>
      </div>
      <div className="flex items-center justify-center border-t-2 border-blumine-200 p-6 my-4 lg:justify-between">
        <div className="mr-12 hidden lg:block"></div>
        {/* Social Network icons container */}
        <div className="flex justify-end">
          {/* Facebook */}
          <a href="#" className="mr-4 text-blumine-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
          ...
          {/* Github */}
          <a href="#" className="text-blumine-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
