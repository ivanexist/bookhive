...
const FilterNavbar = ({
  ...
  onItemsPerPageOptions,
  onItemsPerPage,
  onHandleItemsPerPageChange,
            ...
            <div className="flex items-baseline sm:justify-end lg:justify-between border-b border-blumine-200 py-4">
              ...
              <div className="flex items-center">
                <div className="mx-10">
                  ...
                  >
                    {onItemsPerPageOptions.map((option, key) => (
                  ...
                  <Disclosure defaultOpen={true}>
                    {({ open }) => (
                      <>
                        ...
                        >
                          <Disclosure.Panel className="px-4 pb-2 pt-4 text-sm text-blumine-500">
                            <TreeSelect
                              style={{ width: "100%" }}
