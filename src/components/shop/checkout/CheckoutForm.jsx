  ...
  <div className="col-span-3 px-4 mx-4 text-lg">
    <div className="flex flex-col p-8 my-4 gap-8">
      ...
      <input
        type="email"
        placeholder="Email"
        className="p-2 w-full sm:-my-8 md:my-0 text-base border placeholder:text-gray-400 border-blumine-300 focus:outline-blumine-400 shadow-sm text-blumine-600"
        required
      />
      <input
        type="tel"
      ...
      <input
        ...
        className="p-2 w-full sm:-mt-8 md:mt-0 text-base border placeholder:text-gray-400 border-blumine-300 focus:outline-blumine-400 shadow-sm text-blumine-600"
      />
      <div className="flex">
        <input
          type="checkbox"
