            ...
            <ul className="mb-6 md:mb-0">
              <li className="flex border-b border-b-blumine-200 my-4">
                ...
                <div className="ml-4 mb-4">
                  <p className="text-gray-500">Sidoarjo, Jawa Timur, 61256,</p>
              ...
              <li className="flex border-b border-b-blumine-200 my-4">
                ...
                <div className="ml-4 mb-4">
                  <p className="text-gray-500">+62 853 305 11771</p>
              ...
              <li className="flex border-b border-b-blumine-200 my-4">
                ...
                <div className="ml-4 mb-4">
                  <p className="text-gray-500 ">Monday - Friday: 9AM - 10PM</p>
                  <p className="text-gray-500 ">Weekend: 9AM - 12PM</p>
                </div>
              </li>
            </ul>
          </div>
            ...
            <div className="flex font-bold border-b border-b-blumine-200 pt-2 text-blumine-500">
              <div>
                <svg
                  ...
                  height="1em"
                  viewBox="0 0 24 24"
                  className="h-8 w-8 mr-2 text-blumine-500"
                >
            ...
            <form id="contactForm">
              <div className="mb-6 mt-8">
                <div className="mx-0 mb-1 sm:mb-4">
                  <div className="flex mx-0 mb-1 sm:mb-4">
                    <input
                      ...
                      className="mb-2 mr-4 w-full border border-blumine-400 py-2 pl-2 pr-4 shadow-sm dark:text-blumine-300 sm:mb-0 focus:outline-blumine-500 placeholder:text-gray-400"
                      name="name"
                    />
                    <input
                      type="text"
                ...
                <div className="mx-0 mb-1 sm:mb-4">
                  <label
                    htmlFor="textarea"
                    className="pb-1 text-xs uppercase tracking-wider focus:outline-blumine-500"
                  ></label>
                  <textarea
                    id="textarea"
                    name="textarea"
                    ...
                    className="mb-2 w-full border border-blumine-400 py-2 pl-2 pr-4 shadow-sm sm:mb-0 focus:outline-blumine-500 placeholder:text-gray-400"
                  ></textarea>
                </div>
              </div>
              <div className="text-center">
                <button
                  type="submit"
                  className="w-full bg-blumine-500 hover:bg-blumine-600 text-white px-6 py-3 font-xl sm:mb-0"
                >
                  Send Message
                </button>
              </div>
